...
from dataset.HBDwater_dataset import HBDWaterDataset
...
def train(args):
    cfg = importlib.import_module('configs.HBDWater_task.' + args.config_file)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--config_file", type=str, default='cfg_rein_lora')
    parser.add_argument("--net", type=str, default='vit_b')
    parser.add_argument("--adapter", type=str, default='sam_rein_lora')  # none: sam
