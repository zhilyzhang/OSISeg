...
class ImageEncoderViT(nn.Module):
    def __init__(
        ...
        self.rein_enabled_layers: list = global_attn_indexes
        self.out_indices = global_attn_indexes
        self.reins: Reins = LoRAReins(embed_dims=768)
        ...
        '''
        patch_size大小的区域映射为1。
        将 b, c, m, n的Tensor 先变为 b, c, m // path_size, n // patch_size;然后 b, m//p, n//p, c
        '''
