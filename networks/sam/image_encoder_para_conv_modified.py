...
from .MoE_Conv import ConvLoRA #as Adapter
from .common import LayerNorm2d, MLPBlock, Adapter, SpatialAdapterNew
...
class Block(nn.Module):
    ...
    def __init__(
        ...
        self.Space_Adapter = SpatialAdapterNew(dim, skip_connect=False)  # with skip connection
        self.scale = scale
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        x = shortcut + x + self.scale * self.Space_Adapter(shortcut)
        xn = self.norm2(x)
