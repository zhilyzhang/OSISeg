...
from .scribble_sampler import generate_spline_point_within_mask

class InterSegScribble(object):
    '''
    points, bbox, 一次交互情况，
    '''
    def __init__(self,
    ...
    def make_batch_sample(self, batch_image_path, batch_gt_json_path):
        ...
        for i in range(self.batch_size):
            ...
            if prompt_type == 1:
                ...
                points = generate_spline_point_within_mask(np.array(mask), N=5)
...
if __name__ == '__main__':
    ...
    iter_seg_data = InterSegScribble(image_paths=train_image_paths,
