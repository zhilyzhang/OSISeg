...
class HBDWaterDataset:
    def __init__(self, image_dir, gt_mask_dir,
        ...
        if self.mode == 'test':
            ...
            self.data_pts = glob(osp.join('/home/zzl/datasets/waterbody_data/HBD_water_data/test_data_vis_ref_latest/test_vis_data',
                                          '*.pt'))
        else:
            self.load_data()
...
if __name__ == '__main__':
    # Example usage
    image_dir = '/home/zzl/datasets/waterbody_data/HBD_water_data/train/image'
    ann_path = '/home/zzl/datasets/waterbody_data/HBD_water_data/train/label_checked'
    ...
    save_test_sample_dir = '/home/zzl/datasets/waterbody_data/HBD_water_data/test_data'
