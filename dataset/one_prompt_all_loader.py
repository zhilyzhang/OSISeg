...
class InterSegOnePrompt(object):
    ...
    def __init__(self,
        ...
        if self.mode == 'test':
            ...
            self.data_pts = glob(osp.join('/home/zzl/datasets/building_data/EVLab_building/test_data_paper_and_vis_samples/test_data_paper_vis', '*.pt'))
...
if __name__ == '__main__':
    ...
    save_test_sample_dir = '/home/zzl/datasets/building_data/EVLab_building/test_data'
    os.makedirs(save_test_sample_dir, exist_ok=True)

    iter_seg_data = InterSegOnePrompt(
        image_paths=val_image_paths,
        ann_paths=val_ann_paths,
        debug=False,
        mode='test',
        model=net,
        device=device,
