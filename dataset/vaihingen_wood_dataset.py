...
class WoodLandDataset:
    def __init__(self, image_dir, gt_mask_dir,
        ...
        self.data_pts = []
        if self.mode == 'test':
            self.data_pts = glob(osp.join('/home/zzl/datasets/ISPRS_data/Vaihingen_data/vaihingen_dataset/val/test_data',
                                          '*.pt'))
        # 数据信息
        if debug:
            if self.mode == 'test':
...
if __name__ == '__main__':
    # Example usage
    image_dir = '/home/zzl/datasets/ISPRS_data/Vaihingen_data/vaihingen_dataset/val/image'
    ann_path = '/home/zzl/datasets/ISPRS_data/Vaihingen_data/vaihingen_dataset/val/label_woodland'
    ...
    save_test_sample_dir = '/home/zzl/datasets/ISPRS_data/Vaihingen_data/vaihingen_dataset/val/test_data'
