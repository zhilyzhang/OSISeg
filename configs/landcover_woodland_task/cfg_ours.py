...
class common(object):
    task = 'landcover_woodland'  # GDBuilding  EVLabBuilding
    output_dir = '/home/zzl/experiments/InterSegAdapter/paper_projects/landcover_woodland_tasks/sam_oursv4'
    gpu_id = 0

class data(object):
    data_dir = ''
    train_image_path = '/home/zzl/datasets/landcover.ai.dataset/train/img'
    train_ann_path = '/home/zzl/datasets/landcover.ai.dataset/train/label.woodland'
    val_image_path = '/home/zzl/datasets/landcover.ai.dataset/test/img'
    val_ann_path = '/home/zzl/datasets/landcover.ai.dataset/test/label.woodland'
...
class test(object):
    predict_flag = False
    checkpoint = '/home/zzl/experiments/InterSegAdapter/paper_projects/landcover_woodland_tasks/sam_oursv2/landcover_woodland_epo_36_bs_8/weight_epoch_27_IoU_0.9381.pth'
