...
class common(object):
    task = 'EVLabBuilding_center_points'  # GDBuilding  EVLabBuilding
...
class train(object):
    ...
    epochs = 36
    debug = False
    choice_point_type = 'center_point' # random_point
    prompt_types = [1]
    ''' 提示类型 ：
                    ① 只有一个正样本点；
                    ② 只有一个bbox
...
class test(object):
    predict_flag = False
    # checkpoint = '/home/zzl/experiments/InterSegAdapter/paper_projects/sam_para_data_update_std/EVLabBuilding_points_epo_36_bs_8/weight_epoch_25_IoU_0.719.pth'
    checkpoint = '/home/zzl/experiments/InterSegAdapter/paper_projects/sam_para_data_update_std/EVLabBuilding_center_points_epo_36_bs_8/weight_epoch_33_IoU_0.8604.pth'
