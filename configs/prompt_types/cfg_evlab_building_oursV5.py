...
class common(object):
    task = 'EVLabBuilding_center_point_box_scribbles'  # GDBuilding  EVLabBuilding
...
class test(object):
    predict_flag = False
    checkpoint = '/home/zzl/experiments/InterSegAdapter/paper_projects/sam_adapter_prompt_types/EVLabBuilding_center_point_box_scribbles_epo_36_bs_8/weight_epoch_25_IoU_0.8607.pth'
