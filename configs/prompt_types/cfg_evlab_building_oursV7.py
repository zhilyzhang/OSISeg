...
class common(object):
    task = 'EVLabBuilding_init_mask_point'  # GDBuilding  EVLabBuilding
...
class test(object):
    predict_flag = False
    checkpoint = '/home/zzl/experiments/InterSegAdapter/paper_projects/sam_adapter_prompt_types/EVLabBuilding_init_mask_point_epo_36_bs_8/weight_epoch_27_IoU_0.8435.pth'
