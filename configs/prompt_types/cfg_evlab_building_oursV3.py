...
class common(object):
    task = 'EVLabBuilding_scribbles'  # GDBuilding  EVLabBuilding
...
class test(object):
    predict_flag = False
    checkpoint = '/home/zzl/experiments/InterSegAdapter/paper_projects/sam_adapter_prompt_types/EVLabBuilding_scribbles_epo_36_bs_8/weight_epoch_26_IoU_0.8988.pth'
