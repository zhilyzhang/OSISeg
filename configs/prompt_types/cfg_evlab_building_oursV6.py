...
class common(object):
    task = 'EVLabBuilding_center_point_box_scribbles_all'  # GDBuilding  EVLabBuilding
...
class test(object):
    predict_flag = False
    checkpoint = '/home/zzl/experiments/InterSegAdapter/paper_projects/sam_para_data_update_std/EVLabBuilding_point_box_scribbles_all_epo_36_bs_8/weight_epoch_33_IoU_0.8326.pth'
