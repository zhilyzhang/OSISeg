...
class common(object):
    ...
    output_dir = '/home/zzl/experiments/InterSegAdapter/paper_projects/backbone_types/convnextv2_all'
    gpu_id = 0
...
class test(object):
    predict_flag = False
    checkpoint = '/home/zzl/experiments/InterSegAdapter/paper_projects/backbone_types/convnextv2_all/EVLabBuilding_epo_36_bs_8/weight_epoch_35_IoU_0.7639.pth'
