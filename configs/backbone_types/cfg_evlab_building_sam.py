...
class common(object):
    task = 'EVLabBuilding_points'  # GDBuilding  EVLabBuilding
    output_dir = '/home/zzl/experiments/InterSegAdapter/paper_projects/adapter_locationsV2/sam_decoder'
    gpu_id = 0
...
class test(object):
    predict_flag = False
    checkpoint = '/home/zzl/experiments/InterSegAdapter/paper_projects/adapter_locationsV2/sam_all/EVLabBuilding_points_epo_36_bs_8/weight_epoch_33_IoU_0.8247.pth'
