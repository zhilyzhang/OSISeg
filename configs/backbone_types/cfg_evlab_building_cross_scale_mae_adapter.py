...
class common(object):
    task = 'EVLabBuilding'  # GDBuilding  EVLabBuilding
    output_dir = '/home/zzl/experiments/InterSegAdapter/paper_projects/backbone_types/cross_scale_adapterV2'
    gpu_id = 0
...
class test(object):
    predict_flag = False
    checkpoint = '/home/zzl/experiments/InterSegAdapter/paper_projects/backbone_types/dk_vitb_all/EVLabBuilding_epo_36_bs_8/weight_epoch_33_IoU_0.6919.pth'
