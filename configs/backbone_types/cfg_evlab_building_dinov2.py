...
class common(object):
    ...
    output_dir = '/home/zzl/experiments/InterSegAdapter/paper_projects/backbone_types/dinov2_all'
    gpu_id = 0
...
class test(object):
    predict_flag = False
    checkpoint = '/home/zzl/experiments/InterSegAdapter/paper_projects/backbone_types/dinov2_all/EVLabBuilding_epo_36_bs_8/weight_epoch_33_IoU_0.7211.pth'
