...
class common(object):
    task = 'HBDwater'  # GDBuilding  EVLabBuilding
    output_dir = '/home/zzl/experiments/InterSegAdapter/paper_projects/HBDWater_tasks/sam_oursv2'
    gpu_id = 0


class data(object):
    data_dir = ''
    train_image_path = '/home/zzl/datasets/waterbody_data/HBD_water_data/train/image'
    train_ann_path = '/home/zzl/datasets/waterbody_data/HBD_water_data/train/label_checked'
    val_image_path = '/home/zzl/datasets/waterbody_data/HBD_water_data/test/image'
    val_ann_path = '/home/zzl/datasets/waterbody_data/HBD_water_data/test/label_checked'
...
class test(object):
    predict_flag = False
    checkpoint = '/home/zzl/experiments/InterSegAdapter/paper_projects/HBDWater_tasks/sam_oursv2/HBDwater_epo_36_bs_8/weight_epoch_36_IoU_0.9306.pth'
