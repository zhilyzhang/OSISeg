...
class common(object):
    ...
    output_dir = '/home/zzl/experiments/InterSegAdapter/paper_projects/adapter_locationsV2/sam_para_latest'
    gpu_id = 0
...
class test(object):
    predict_flag = False
    checkpoint = '/home/zzl/experiments/InterSegAdapter/paper_projects/adapter_locationsV2/sam_para_conv_ours/EVLabBuilding_epo_36_bs_8/weight_epoch_33_IoU_0.866.pth'
